...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.cg.exception.DataInputException.class)
    public ResponseEntity<?> dataInputException(com.cg.exception.DataInputException ex, WebRequest request) {
        Map<String, String> body = new HashMap<>();
